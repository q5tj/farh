...
/**
 * Searchable category dropdown. Was a horizontal chip strip in
 * provider onboarding — the chip strip stopped scaling once we had
 * 20+ categories. Modal sheet with search reads better.
 */
    ...
    <View>
      ...
      >
        {selected ? (
          ...
          >
            <Feather name={selected.icon} size={14} color="#ffffff" />
          </View>
        ) : (
          <Feather name="grid" size={16} color={c.mutedForeground} />
        )}
        <Text
          style={[
            styles.fieldText,
          ...
          numberOfLines={1}
        >
          {selected ? selected.name : t("pickCategory")}
        </Text>
