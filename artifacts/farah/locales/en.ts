...
export const en: Strings = {
  ...
  resetPasswordBody: "Enter your email and we'll send you a link to set a new password.",
  resetPasswordSend: "Send link",
  resetPasswordSent: "Link sent. Check your email.",
  ...
  adminMoyasarStatus: "Moyasar Connections",
  adminMoyasarStatusDesc: "Track stores that haven't connected Moyasar yet",
  moyasarStatusTitle: "Moyasar Connection Status",
  moyasarTabPending: "Pending",
  moyasarTabActive: "Active",
  moyasarTabAll: "All",
  moyasarActive: "Moyasar active",
  moyasarNotConnected: "Not connected",
  moyasarSendWhatsApp: "Follow up via WhatsApp",
  moyasarNoPhone: "No phone number on file",
  moyasarEmptyTitle: "No stores",
  moyasarEmptyBody: "No approved stores in this filter.",
  openBooking: "Open booking",
  moyasarShowUnconnectedTitle: "Show stores without Moyasar to customers",
  moyasarShowUnconnectedOn: "On: stores without Moyasar are visible on the home screen (useful when demoing the app to new providers).",
  moyasarShowUnconnectedOff: "Off: stores without Moyasar are hidden to prevent failed checkouts.",
  profileSectionWorkspace: "Workspace",
  profileSectionAccount: "Account",
  profileSectionPreferences: "Preferences",
  profileSectionSupport: "Help & support",
  profileSectionDanger: "Account actions",
  ...
  cityOutsideAreasTitle: "This provider doesn't serve \"{{city}}\"",
  cityOutsideAreasBody:
    "Provider service areas: {{areas}}. If you need another location, pick a provider that serves your city.",
  cityOutsideAreasContinue: "Continue at my own risk",
  ...
  adminPayouts: "Provider payouts",
  adminPayoutsDesc: "Provider's share of each payment + Moyasar Payouts processing",
  payoutStatusManualPending: "Awaiting manual transfer",
  payoutStatusQueued: "Queued",
  payoutStatusInitiated: "Processing",
  payoutStatusCompleted: "Completed",
  payoutStatusFailed: "Failed",
  payoutStatusCancelled: "Cancelled",
  payoutTypeDeposit: "Deposit share",
  payoutTypeFinal: "Final payment share",
  payoutTypeManual: "Manual settlement",
  payoutsQueuedCount: "{{count}} payouts awaiting processing",
  processAllPayouts: "Process all",
  processPayoutNow: "Process now",
  markManuallySettled: "Mark manually settled",
  noPayoutsInCategory: "No payouts in this filter",
  processQueuedPayoutsTitle: "Process all payouts",
  processQueuedPayoutsBody:
    "All queued payouts will be sent to Moyasar now.",
  payoutsProcessedTitle: "Processed",
  payoutsProcessedBody: "Succeeded: {{ok}} — Failed: {{fail}}",
  markPayoutManuallySettledTitle: "Confirm manual settlement",
  markPayoutManuallySettledBody:
    "Confirm you transferred {{amount}} SAR to the provider manually (bank transfer outside the system)?",
