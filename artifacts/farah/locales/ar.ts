...
export const ar = {
  ...
  resetPasswordBody: "أدخل بريدك الإلكتروني وسنرسل لك رابطًا لإنشاء كلمة مرور جديدة.",
  resetPasswordSend: "إرسال الرابط",
  resetPasswordSent: "تم إرسال الرابط. تحقق من بريدك الإلكتروني.",
  ...
  adminMoyasarStatus: "ربط ميسر للمتاجر",
  adminMoyasarStatusDesc: "تابع المتاجر اللي ما ربطت ميسر",
  moyasarStatusTitle: "حالة ربط ميسر",
  moyasarTabPending: "بانتظار الربط",
  moyasarTabActive: "نشطة",
  moyasarTabAll: "الكل",
  moyasarActive: "ميسر مفعّل",
  moyasarNotConnected: "غير مربوط",
  moyasarSendWhatsApp: "إرسال متابعة عبر واتساب",
  moyasarNoPhone: "لا يوجد رقم جوال للتواصل",
  moyasarEmptyTitle: "لا توجد متاجر",
  moyasarEmptyBody: "لا توجد متاجر معتمدة ضمن هذا التصنيف.",
  openBooking: "فتح الحجز",
  moyasarShowUnconnectedTitle: "إظهار المتاجر بدون ميسر للعملاء",
  moyasarShowUnconnectedOn: "مفعّل: المتاجر غير المربوطة تظهر في الواجهة الرئيسية (مفيد لعرض التطبيق للمزودين الجدد).",
  moyasarShowUnconnectedOff: "معطّل: المتاجر غير المربوطة بميسر مخفية لتجنّب فشل الدفع.",
  profileSectionWorkspace: "مساحة العمل",
  profileSectionAccount: "الحساب",
  profileSectionPreferences: "التفضيلات",
  profileSectionSupport: "الدعم والمساعدة",
  profileSectionDanger: "إجراءات الحساب",
  ...
  verificationApprovedToast: "تم اعتماد حسابك! أهلاً بك في فرحتكمتكم.",
  ...
  walletHeldNoticeBody:
    "العربون وباقي السعر يصلانك مباشرة في حسابك بميسر — سواء سدّد العميل عبر التطبيق أو كاش أو حوالة. فرحتكم لا تستلم أو تحوّل أي مبلغ من سعر الخدمة. بعد إنهاء الخدمة، عليك سداد عمولة المنصة من كشف حسابك بالأسفل.",
  commissionDueTitle: "عمولات منصة مستحقة عليك",
  commissionDueIntro:
    "هذه عمولات فرحتكم على خدمات استلمت كامل مستحقاتها. سدّدها من هنا مباشرة عبر ميسر.",
  payNow: "سدّد الآن",
  ...
  customerEmailLabel: "إيميل العميل",
  remainingAmountLabel: "المتبقي على العميل",
  commissionDueLabel: "عمولة المنصة المتبقية عليك",
  methodOnlineTitle: "عبر التطبيق",
  methodOnlineDesc:
    "نرسل إشعار للعميل ليدفع المتبقي ببطاقته مباشرة في حسابك بميسر. بعد ما يدفع، عليك عمولة المنصة على السعر الكامل — تظهر لك بكشف حسابك.",
  methodCashTitle: "كاش",
  methodCashDesc:
  ...
  goToStatement: "الذهاب إلى كشف حسابي",
  checkAgain: "تحقق مرة أخرى",
  commissionPaymentSuccessTitle: "تم سداد العمولة",
  commissionPaymentSuccessDesc: "شكراً! تم سداد عمولة المنصة بنجاح.",
