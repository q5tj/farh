...
-- §3 STORAGE BUCKETS
-- ============================================================
-- `avatars` was previously created ad-hoc in the dashboard; declare it here
-- so a fresh project bootstraps cleanly. ON CONFLICT keeps it in sync.
...
-- ============================================================
-- §3.5 STORAGE RLS — avatars (public read, owner writes)
-- ============================================================
-- Layout: <auth_user_id>/avatar.webp
